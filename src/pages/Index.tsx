...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4 md:p-6 relative overflow-hidden">
      {showTestBanner && (
        <div className="fixed top-0 left-0 right-0 bg-yellow-400 text-black p-2 text-center font-bold z-50 shadow-md">
          IMPORTANT: Phone number management is now available in your profile dropdown menu!
          <button 
            className="ml-2 bg-black text-white px-2 py-1 rounded-md text-xs"
